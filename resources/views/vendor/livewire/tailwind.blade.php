                                    ...
                                    <span wire:key="paginator-{{ $paginator->getPageName() }}-page{{ $page }}">
                                        @if ($page == $paginator->currentPage())
                                            <span aria-current="page"
                                                class="relative inline-flex items-center px-4 py-2 text-sm font-medium bg-red-600 border border-red-600 text-white z-10 focus:outline-none focus:ring ring-red-300 focus:border-red-300">
                                                {{ $page }}
                                            </span>
                                        @else
